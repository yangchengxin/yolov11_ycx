...
//	nvinfer1::INetworkDefinition *network = builder->createNetworkV2(0U);
    ...
    *******************************************************************************************************/
    ...
    // 从【B，144，H * W】中切出【B， 64， H * W】作为回归特征
    nvinfer1::ISliceLayer *split23_0_0 = network->addSlice(
            *shuffle23_0->getOutput(0),
            nvinfer1::Dims3{0, 0, 0},         // start
            nvinfer1::Dims3{kBatchSize, 64, (kInputH / strides[0]) * (kInputW / strides[0])},    // size
            nvinfer1::Dims3{1, 1, 1});        // step
    // 从【B，144，H * W】中切出【B， kNumClass， H * W】作为分类特征
    nvinfer1::ISliceLayer *split23_0_1 = network->addSlice(
            *shuffle23_0->getOutput(0),
            nvinfer1::Dims3{0, 64, 0},        // start
            nvinfer1::Dims3{kBatchSize, kNumClass, (kInputH / strides[0]) * (kInputW / strides[0])},   // size 
            nvinfer1::Dims3{1, 1, 1});        // step
